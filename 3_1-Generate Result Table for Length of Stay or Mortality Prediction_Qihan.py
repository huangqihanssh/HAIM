...
folder_name = 'result/mortality-result'
...
for i in tqdm(range(21)):
    ...
    for j in range(1):
        ...
        aucroc_lis.append(df['Test AUC'].values[0])
        aucpr_lis.append(df['Test AUC'].values[0])
...
df_result[['AUCROC_mean']].to_csv('result/result-table/AUCROC_mean_{}_pred.csv'.format(task))
df_result[['AUCPR_mean']].to_csv('result/result-table/AUCPR_mean_{}_pred.csv'.format(task))
df_result[['AUCROC_std']].to_csv('result/result-table/AUCROC_std_{}_pred.csv'.format(task))
df_result[['AUCPR_std']].to_csv('result/result-table/AUCPR_std_{}_pred.csv'.format(task))
df_result[['F1_mean']].to_csv('result/result-table/F1_mean_{}_pred.csv'.format(task))
df_result[['F1_std']].to_csv('result/result-table/F1_std_{}_pred.csv'.format(task))
