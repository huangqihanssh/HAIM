...
df = pd.read_csv("result/result-table/AUC_All_los_pred.csv")
...
def get_ft_pr_tables(y_true, y_pred, mode, seed):
    ...
    df_result_ft.to_csv('result/result-table/df_result_mortality_ft-{}-{}.csv'.format(mode, seed))
